...
//━━━━━━━━━━━━━━━[ BUAT BIO BOT ]━━━━━━━━━━━━━━━\\
runi = process.uptime() 
           dit.setStatus(`zafi Bot Aktif Selama ${kyun(runi)} `).catch((_)=>_);
...
anu =`
Selamat datang Di Menu zafi Bot 👋

☯ Tampilan Menu zafi Bot ☯
𝑷𝒓𝒆𝒇𝒊𝒙 : MULTI & PREFIX
...
┃❆${prefix}bear {teks}
└──────────────`
sendButImage(from, anu,`Selamat Mencoba zafi Bot\n${Tanggal}`, thumb, [
